"""
ubuntu 18 profile for cs 744 Fall 2020 Final Project. 
Emulate the AWS m3.2xlarge machine on the xgboost paper.

Spec of m3.2xlarge: Each machine contains 8 virtual cores, 30GB of RAM and two 80GB SSD local disks.
"""
...
pc.defineParameter("cores", "Number of Cores per machine.", portal.ParameterType.INTEGER, 8,
                   longDescription="The number of cores for each machine.")


pc.defineParameter("memory", "Memory (GB) per node", portal.ParameterType.INTEGER, 30,
                   longDescription="Memory of the node.")

pc.defineParameter("disk", "Disk (GB) per node", portal.ParameterType.INTEGER, 80,
